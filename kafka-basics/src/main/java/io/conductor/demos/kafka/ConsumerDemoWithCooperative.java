...
public class ConsumerDemoWithCooperative {
    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoWithCooperative.class.getName());
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty("partition.assignment.strategy", CooperativeStickyAssignor.class.getName()); // using incremental assignment
        //create consumer
